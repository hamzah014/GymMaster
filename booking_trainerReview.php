                        ...
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                if(isset($_POST) && !empty($_POST)){
                                    ...
                                    $sqlInsert = "INSERT INTO followup (book_id,review) 
                                    VALUES ('$bookid','$review')";      
                            ...
                            <!-- Horizontal Form -->
                            <form method="post" action="booking_trainerReview.php" enctype="multipart/form-data">

                                <input class="d-none" name="bookid" type="text" id="bookid" value="<?php echo $bookid; ?>">

                                <div class="row mb-3">
                                    <label for="review" class="col-12 col-form-label">Review/Followup :</label>
                                    <div class="col-12">
                                        <textarea name="review" class="form-control tinymce-editor" id="review"></textarea>
                                    </div>
                                </div>
