        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Session Complete Payment Booking Form</h5>
                            <br />
                                ...
                                if(isset($_POST) && !empty($_POST)){
                                    ...
                                    if(move_uploaded_file( $_FILES["resitFile"]["tmp_name"],$dir . $renameFile)){
                                        ...
                                        if($resultInsert2 == true){
                                            ...
                                            echo '<script>alert("Payment has been submitted successfully.");</script>';
                                    ...
                                    // INNER JOIN users ON trainid = users.id LIMIT 1";
                            ...
                            <p><b>Completed Session Payment Form</b></p>
                            ...
                            <!-- Horizontal Form -->
                            <form method="post" action="booking_paymentComplete.php" enctype="multipart/form-data">
